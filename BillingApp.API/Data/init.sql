...
-- Fix broken BillItems schema from previous migrations
ALTER TABLE "BillItems" ADD COLUMN IF NOT EXISTS "BillId" INT REFERENCES "Bills"("Id") ON DELETE CASCADE;
ALTER TABLE "BillItems" ADD COLUMN IF NOT EXISTS "ItemId" INT REFERENCES "Items"("Id");
ALTER TABLE "BillItems" ADD COLUMN IF NOT EXISTS "ItemName" VARCHAR(100);
ALTER TABLE "BillItems" ADD COLUMN IF NOT EXISTS "Price" DECIMAL(18,2);
ALTER TABLE "BillItems" ADD COLUMN IF NOT EXISTS "Quantity" INT DEFAULT 1;
